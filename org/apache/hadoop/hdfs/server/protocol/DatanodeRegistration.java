 ...
 * 
 */
public class DatanodeRegistration extends DatanodeID implements Writable, DatanodeRegistrationMXBean {
 ...
 public String toString() {
  ...
  public void readFields(DataInput in) throws IOException {
    ...
    storageInfo.layoutVersion = versionID = in.readInt();
